...
mod tests {
    ...
    fn test_verify_wallet_commitment() {
        ...
        let wrong_commitment =
            compute_commitment(&wrong_wallet).expect("should compute commitment");
        let public_inputs =
    ...
    fn test_verify_wallet_transition() {
        ...
        let insert_channel = WalletInput::InsertChannel { channel_id, channel_commitment };
        ...
        let new_wallet =
            apply_input(old_wallet_copy, &insert_channel).expect("Valid transition should succeed");
        let proof =

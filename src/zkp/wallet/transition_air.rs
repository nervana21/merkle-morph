...
mod tests {
    ...
    fn test_eval() {
        ...
        use crate::zkp::wallet::{prove_wallet_transition, verify_wallet_transition, MAX_CHANNELS};
        ...
        let empty_commitment =
            compute_commitment(&empty_wallet).expect("should compute commitment");
        ...
        let old_commitment = compute_commitment(&old_wallet).expect("should compute commitment");
        let new_commitment = compute_commitment(&new_wallet).expect("should compute commitment");
        ...
        let input = WalletInput::RemoveChannel { channel_id: remove_channel_id };
        let old_wallet_copy = WalletState {
            id: old_wallet.id,
            channels: old_wallet.channels.clone(),
            commitment: old_wallet.commitment,

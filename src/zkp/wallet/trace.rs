...
use crate::types::{Bytes32, CHAIN_DOMAIN, WALLET_HASH_DOMAIN, WALLET_INIT_DOMAIN};
...
/// Maximum number of channels supported in a single wallet proof
...
mod tests {
    ...
    fn empty_wallet_trace() {
        ...
        let expected = compute_commitment(&w).expect("should compute commitment");

...
/// Batch-level inputs and helpers for whole-batch proof flows.
pub mod batch;
mod builder_wrapper;
mod channel;
mod column_slice;
...
pub use batch::BatchPublicInputs;
pub use channel::{
    prove_channel_transition, prove_cooperative_close_transition, prove_force_close_transition,
    prove_recover_transition, verify_channel_transition, ChannelPublicInputs,
};
pub use global::{

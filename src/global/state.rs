...
use crate::types::WalletCommitments;
...
impl GlobalState {
    ...
    pub fn with_root_and_nonce(root: GlobalRoot, nonce: u32) -> Self {
    ...
    /// * `nonce` - Current nonce
    pub fn with_commitments(root: GlobalRoot, changes: WalletCommitments, nonce: u32) -> Self {

...
use crate::global::commitment::types::SmtNodeHash;
...
pub trait Database: Send + Sync {
    ...
    fn get_wallet_commitment(&self, wallet_id: &[u8; 32]) -> Result<Option<WalletCommitment>>;
    ...
    fn put_smt_node(&self, node_key: &[u8], node_hash: &SmtNodeHash) -> Result<()>;
    ...
    fn get_wallets_by_prefix(
        ...
        prefix: &[u8],
        depth: u8,
    ) -> Result<BTreeMap<WalletId, WalletCommitment>>;

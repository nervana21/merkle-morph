...
/// Alias for the global SMT root over all wallets.
///
/// This is the top-level commitment produced by composing all shard roots.
pub type GlobalRoot = Bytes32;

/// Alias for the commitment hash of a global transition witness.
///
/// This hash uniquely identifies a transition witness and commits to all witness data.
pub type TransitionWitnessHash = Bytes32;

/// Alias for subtree root hashes
pub type SubtreeRootHash = Bytes32;

/// Alias for Sparse Merkle Tree internal node hashes
pub type SmtNodeHash = Bytes32;

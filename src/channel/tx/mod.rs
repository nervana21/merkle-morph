...
//!
//! All transaction builders use Silent Payments (BIP-0352) for recipient outputs.
//! Force close, cooperative close, and challenge transactions use version 3 (TRUC)
//! to enable package relay for reliable fee-bumping via CPFP.
